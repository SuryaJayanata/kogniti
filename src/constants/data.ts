...
export const STATS_DATA = [
  {
    ...
    description: "Insights driven by deep behavioral analysis and market research."
  },
  {
    number: "350+",
    label: "Successful Campaigns",
    description: "From emerging startups to global industry leaders."
  },
  {
    number: "98%",
    label: "Client Retention",
    description: "Building long-term partnerships through consistent results."
  },
  {
    number: "15+",
